...
function download(req, res, filepath, onError, onDone, onProgress) {
...
module.exports = function(req, res,option = {}) {
  ...
  return download(req, res,filepath, onError, onDone, onProgress);
};
