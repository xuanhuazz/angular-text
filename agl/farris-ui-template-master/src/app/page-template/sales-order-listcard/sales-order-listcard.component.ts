...
@Component({
  selector: 'app-sales-order-listcard',
  templateUrl: './sales-order-listcard.component.html',
  styleUrls: ['./sales-order-listcard.component.css']
})
export class SalesOrderListcardComponent implements OnInit {
  @HostBinding('class')
