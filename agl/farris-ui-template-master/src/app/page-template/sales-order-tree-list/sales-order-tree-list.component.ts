...
@Component({
  selector: 'app-sales-order-tree-list',
  templateUrl: './sales-order-tree-list.component.html',
  styleUrls: ['./sales-order-tree-list.component.css']
})
export class SalesOrderTreeListComponent implements OnInit {
  @HostBinding('class')
