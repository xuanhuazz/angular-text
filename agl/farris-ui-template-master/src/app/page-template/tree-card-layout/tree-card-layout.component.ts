...
@Component({
  selector: 'app-tree-card-layout',
  templateUrl: './tree-card-layout.component.html',
  styleUrls: ['./tree-card-layout.component.css']
})
export class TreeCardLayoutComponent implements OnInit {
  @HostBinding('class')
