...
@Component({
  selector: 'app-card-single-tab',
  templateUrl: './card-single-tab.component.html',
  styleUrls: ['./card-single-tab.component.css']
})
export class CardSingleTabComponent implements OnInit {
