...
@Component({
  selector: 'app-list-card-layout',
  templateUrl: './list-card-layout.component.html',
  styleUrls: ['./list-card-layout.component.css']
})
export class ListCardLayoutComponent implements OnInit {
  @HostBinding('class')
