...
@Component({
  selector: 'tree-mainsubcard',
  templateUrl: './tree-mainsubcard.component.html',
  styleUrls: ['./tree-mainsubcard.component.scss']
})
export class TreeMainsubcardComponent implements OnInit {
  defaultData = null;
  // 帮助的数据
  gridOpts = {
